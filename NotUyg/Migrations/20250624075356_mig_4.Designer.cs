...
namespace NotUyg.Migrations
{
    ...
    [Migration("20250624075356_mig_4")]
    partial class mig_4
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NotUyg.Entity.Option", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NotUyg.Entity.Poll", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NotUyg.Entity.UserVote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("NotUyg.Entity.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("NotUyg.Entity.Option", b =>
                {
                    b.HasOne("NotUyg.Entity.Poll", "Poll")
                        .WithMany("Options")
            ...
            modelBuilder.Entity("NotUyg.Entity.UserVote", b =>
                {
                    b.HasOne("NotUyg.Entity.Option", "Option")
                        .WithMany()
